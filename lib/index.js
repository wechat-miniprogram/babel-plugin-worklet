...
function buildWorkletString(t, fun, closureVariables, name) {
  ...
  // const workletFunctionWrapper = t.functionExpression(
  //   null,
  //   [t.identifier("jsThis")],
  //   t.blockStatement([t.returnStatement(workletFunction)])
  // );
    ...
    CallExpression: {
      enter(path) {
        ...
        if (funcName === 'bind') {
          ...
          path.replaceWith(t.identifier(funcName))
          return
        }
